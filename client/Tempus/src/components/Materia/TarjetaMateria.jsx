export default function TarjetaMateria({ materia, children }) {
  return (
    <div className="relative bg-white shadow-lg rounded-xl p-5 w-full h-full border-2 border-gray-100 flex flex-col justify-between transition-all hover:border-blue-200">
